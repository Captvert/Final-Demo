...
function currentLanguage(){
    ...
    if (languageStored =='Arabic') {
        ...
        timeText.innerText = 'بدايات أغسطس';
        ...
        canvasItemsContainerA.innerHTML = "<div class='category-arabic'>المجوهرات <img src='ImagesFolder/jewelry-icon.png' class='jewelry-icon'></div> <div class='epp-checkmark-arabic'  onclick=' event.stopPropagation()  ; eppPopUp () '>أخلاقيات تصوير المنتج <img src='ImagesFolder/epp-checkmark-icon.png' class='epp-checkmark-icon'></div>";
        ...
        ePPPoint1A.innerHTML = "<div class='epp-point1-text-arabic'><div class = 'epp-point1-arabic-l1'> الغرض من تصوير المنتج جعله يبدو أفضل<strong style = 'margin-left: clamp(0px , 1.4vw , 7.126px);'> الصدق هو أولوية: ليس</strong> </div> <div class = 'epp-point1-arabic-l2'> <strong>  من صورته الحقيقية مما قد يخدع عملائه المحتملين</strong> </div> <div class = 'epp-point1-arabic-l3'> بل إظهاره بطريقة يكون فيها عروض بوضوح و </div> <div class = 'epp-point1-arabic-l4'>  .بطريقة تمثل العلامة التجارية</div> </div> <div class='bulletpoint1'></div>";
        ...
        const timeText = document.querySelector('.time-text');
        timeText.innerText = 'Early August';
        ...
        canvasItemsContainer.innerHTML = "<div class='epp-checkmark'  onclick='  event.stopPropagation()  ; eppPopUp () '><img src='ImagesFolder/epp-checkmark-icon.png' class='epp-checkmark-icon'>EPP Checkmark</div><div class='category'><img src='ImagesFolder/jewelry-icon.png' class='jewelry-icon'>Jewelry</div>"
...
function switchLanguage(){
    ...
    if (langButton.innerHTML == 'ع') {
        ...
        footerDescription.innerHTML = "This button below will start you on the first step. Join the Early August Bookings";
